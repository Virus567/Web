...
К текущему проекту был подключен сборщик модулей Webpack.
...
Вывод: в ходе лабораторной работы были изучены основы: веб-фреймворка VUE, сборщика модулей Webpack, библиотеки Axios, языка программирования TypeScript. С помощью перечисленных компонентов на практике реализовано отображение на странице фамилии, имени, отчества и главной страницы сайта ВятГУ.
